...
[![Release pipeline](https://ci.eionet.europa.eu/buildStatus/icon?job=volto%2Ffise-frontend%2F4.7.0&build=last&subject=release%20v4.7.0%20pipeline)](https://ci.eionet.europa.eu/view/Github/job/volto/job/fise-frontend/job/4.7.0/lastBuild/display/redirect/)
