...
[![Release pipeline](https://ci.eionet.europa.eu/buildStatus/icon?job=volto%2Ffise-frontend%2F3.3.0&build=last&subject=release%20v3.3.0%20pipeline)](https://ci.eionet.europa.eu/view/Github/job/volto/job/fise-frontend/job/3.3.0/lastBuild/display/redirect/)
